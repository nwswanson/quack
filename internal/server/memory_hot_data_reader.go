...
func (r *memoryHotDataReader) GetServerSettings(ctx context.Context) (ServerSettings, error) {
...
func (r *memoryHotDataReader) LoadPolicies(ctx context.Context, scopes []PolicyScope) ([]PolicyRecord, error) {
	...
	return append([]PolicyRecord(nil), value.([]PolicyRecord)...), nil
}
...
func (r *memoryHotDataReader) ListCurrentSiteManifests(ctx context.Context) ([]CurrentSiteManifest, error) {
	...
	return cloneCurrentSiteManifests(value.([]CurrentSiteManifest)), nil
}

func (r *memoryHotDataReader) ListPolicyViolations(ctx context.Context, siteSHA string, version int64) ([]PolicyViolation, error) {
	...
	return append([]PolicyViolation(nil), value.([]PolicyViolation)...), nil
}

func (r *memoryHotDataReader) FindCurrentSiteFile(ctx context.Context, site string, relativePath string) (UploadFileRecord, bool, bool, error) {
	...
	if err != nil {
		return UploadFileRecord{}, false, false, err
	}
...
func (r *memoryHotDataReader) ServeSiteFile(ctx context.Context, site string, urlPath string) (ServeSiteFileDecision, error) {
...
func policyScopesKey(scopes []PolicyScope) string {
